...
<body>
	...
	<h3>2.변수 제거(==속정 제거)-c:remove 태그</h3>
	<pre>
	...
	<ul>
		...
		<li>requestScope : ${requestScope.test2}</li>
		<li>sessionScope : ${sessionScope.test2}</li>
		<li>applicationScope : ${applicationScope.test2}</li>
	</ul>
